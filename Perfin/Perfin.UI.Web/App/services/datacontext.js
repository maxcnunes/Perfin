...
define([
    ...
    function (
        ...
        var
            ...
            accountRepository = new EntitySet(dataservice.account.getAccounts, modelmapper.account, model.Account.Nullo);
            entryRepository = new EntitySet(dataservice.entry.getEntries, modelmapper.entry, model.Entry.Nullo);
